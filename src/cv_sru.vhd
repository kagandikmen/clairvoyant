    ...
    begin
        if rising_edge(clk_in) then
            if reset_in = '1' then
                ...
                tmp1                := ("00000000" & unsigned(overlap_buf1(7 downto 0))) + ( "00000000" & unsigned(first_word_in    (31 downto 24)));
                storage_unit(0)(0)  <= std_logic_vector(tmp1(8 downto 1));
                
                storage_unit(0)(1)  <= first_word_in    (31 downto 24);
                
                if ctr = 0 then
                    storage_unit(0)(0)  <= first_word_in    (31 downto 24);
                end if;
                ...
                tmp5                := ("00000000" & unsigned(overlap_buf1(7 downto 0))) + ("00000000" & unsigned(overlap_buf2(7 downto 0)))
                                        + ("00000000" & unsigned(first_word_in    (31 downto 24))) + ("00000000" & unsigned(second_word_in    (31 downto 24)));
                ...
                if ctr = 0 then
                    storage_unit(1)(0) <= std_logic_vector(tmp7(8 downto 1));
                end if;
                ...
                overlap_buf1      <= first_word_in  (7 downto 0);
                overlap_buf2      <= second_word_in (7 downto 0);
